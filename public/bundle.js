...
var _StartContainer = __webpack_require__(50);

var _StartContainer2 = _interopRequireDefault(_StartContainer);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_StartContainer2.default, null)
      );
    }
  }]);
...
var _StatusBar = __webpack_require__(76);
...
var StartContainer = function (_Component) {
  _inherits(StartContainer, _Component);

  function StartContainer(props) {
    _classCallCheck(this, StartContainer);

    var _this = _possibleConstructorReturn(this, (StartContainer.__proto__ || Object.getPrototypeOf(StartContainer)).call(this, props));
    ...
    _this.endCountdown = _this.endCountdown.bind(_this);
    _this.incrementPlayers = _this.incrementPlayers.bind(_this);
    return _this;
  }
  ...
  _createClass(StartContainer, [{
    key: 'incrementPlayers',
    value: function incrementPlayers(count) {
    ...
    value: function componentDidMount() {
      ...
      socket.on('number of players', function (count) {
        console.log('There are this many players sent via sockets: ', count);
        _this2.incrementPlayers(count);
      });
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_StatusBar2.default, { stage: this.state.stage, numPlayers: this.state.numPlayers, endCountdown: this.endCountdown })
      );
    }
  }]);
...
var _reactCountdownClock = __webpack_require__(77);
    ...
    value: function render() {
      ...
      switch (this.props.stage) {
        case 'Waiting':
          ...
          break;
        case 'Countdown':
          status = _react2.default.createElement(_reactCountdownClock2.default, { seconds: 10, color: '#000', alpha: 0.9, size: 300, onComplete: this.props.endCountdown });
          break;
        case 'Race':
          status = 'Go!';
          break;
